...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Seus tons personalizados de azul adicionados aqui
        azul: {
          marinho: '#0f172a',  // Texto, cabeçalho e menus escuros
          royal: '#2563eb',    // Botões principais (Comprar, Checkout)
          bebe: '#e0f2fe',     // Fundos leves e banners secundários
        },
        grey: {
          0: "#FFFFFF",
          5: "#F9FAFB",
